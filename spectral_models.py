...
class GPRGNN(torch.nn.Module):
    def __init__(self, dataset, args):
        ...
        self.prop1 = GPR_prop(args.k_order, args.alpha, args.Init)
    ...
    def get_theta(self):
        return self.prop1.temp.clone().detach().cpu().numpy()
...
class BernNet(torch.nn.Module):
    def __init__(self,dataset, args):
        ...
        self.prop1 = Bern_prop(args.k_order)
    ...
    def get_theta(self):
        return torch.relu(self.prop1.temp.clone().detach().cpu()).numpy()
...
class TAGCN(torch.nn.Module):
    def __init__(self, data, args):
        super().__init__()
        self.conv1 = TAGConv(data.num_features, args.hidden)
        self.conv2 = TAGConv(args.hidden, data.num_classes)
        self.dropout = args.dropout
