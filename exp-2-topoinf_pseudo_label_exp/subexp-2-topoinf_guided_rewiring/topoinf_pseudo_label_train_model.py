...
from exp_special_utils import RunExp, topoinf_based_deleting_edges,get_edges_nums
...
from base_utils.base_pseudo_label_utils import get_pseudo_label_matrix, compute_pseudo_label_topoinf ,get_vertex_type_degree_ratio,get_v2t_t2v,get_add_edge,select_vertex ,compute_add_edge_topoinf
...
if __name__ == '__main__':
    ...
    for run_index in range(args.n_runs):
        ...
        v2t , t2v  = get_v2t_t2v (pseudo_label_matrix)
        #print("v2t",v2t)
        #print("t2v",t2v)
        vertex_type_degree_ratio,degree_vertex = get_vertex_type_degree_ratio(v2t,data)
        ...
        for delete_mag in delete_mag_list:
            ...
            if args.delete_unit in ['mode_ratio', 'ratio']:
                ...
                args.delete_num = (pos_num +neg_num)*delete_mag*0.01 
            else:
